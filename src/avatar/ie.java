...
public final class ie extends kj {
    ...
    public final void a(byte[] var1) {
        try {
            this.b((byte) 21);
            super.iOStream.getDataOutputStream().writeByte(var1.length);

            for (int var2 = 0; var2 < var1.length; ++var2) {
                super.iOStream.getDataOutputStream().write(var1[var2]);
            }
    ...
    public final void b(byte var1) {
        try {
            super.e(var1);
            super.iOStream.getDataOutputStream().writeByte(kx.p);
            super.iOStream.getDataOutputStream().writeByte(kx.q);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public final void a(int[] var1, byte var2) {
        try {
            ...
            for (int var3 = 0; var3 < var1.length; ++var3) {
                super.iOStream.getDataOutputStream().writeByte(var1[var3]);
            }
        ...
        try {
            ...
            for (int var3 = 0; var3 < 10; ++var3) {
                if (var1[var3].a != 0) {
                    ...
                    var2 = var1[var3].a;
                    super.iOStream.getDataOutputStream().writeByte(var1[var3].b);
                } else if (var2 != -1) {
                    super.iOStream.getDataOutputStream().writeByte(-1);
                    var2 = -1;
                }
    ...
    public final void a(boolean var1) {
        try {
            this.b((byte) 16);
            super.iOStream.getDataOutputStream().writeBoolean(var1);
        } catch (IOException var2) {
        }
            ...
            for (int var2 = 0; var2 < 8; ++var2) {
                for (int var3 = 0; var3 < 8; ++var3) {
                    if (var1[var2][var3].l) {
                        ...
                        super.iOStream.getDataOutputStream().writeByte((var2 << 3) + var3);
                    }
                }
            }
        } catch (Exception var4) {
        ...
        try {
            ...
            if (var1.size() > 0) {
                for (int var2 = 0; var2 < var1.size(); ++var2) {
                    ...
                    super.iOStream.getDataOutputStream().writeByte(var3.b);
                    var3.b = 0;
                }
            }
        } catch (IOException e) {
